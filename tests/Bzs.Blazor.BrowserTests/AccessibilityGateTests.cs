...
public sealed class AccessibilityGateTests(DemoServerFixture server) : BrowserGatePageTest
{
    ...
    public async Task AutoCatalogCompleteStateHasNoCriticalOrSeriousAxeViolations()
    {
        ...
        await Page.GotoAsync(server.Urls.RenderMode("auto", DemoDestinationUrls.English));
    ...
    {
        BeginBrowserGateTest();
        await Page.GotoAsync(server.Urls.To(DemoCatalogDestinations.Overlays, DemoDestinationUrls.English));
    ...
    {
        BeginBrowserGateTest();
        await Page.GotoAsync(server.Urls.To(DemoCatalogDestinations.Tabs, DemoDestinationUrls.English));
    ...
    {
        BeginBrowserGateTest();
        await Page.GotoAsync(server.Urls.To(DemoCatalogDestinations.Productivity, DemoDestinationUrls.English));
    ...
    public async Task ResponsiveNavigationDrawerStatesHaveNoCriticalOrSeriousAxeViolations()
    {
        ...
        await Page.GotoAsync(server.Urls.To(DemoCatalogDestinations.Layout, DemoDestinationUrls.English));
