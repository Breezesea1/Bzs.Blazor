...
```text
dotnet add package Bzs.Blazor --version 0.1.10
```
...
A strict SemVer tag such as `v0.1.10` starts the GitHub Actions release workflow.
...
Release notes are recorded in `docs/releases/0.1.10.md`.
